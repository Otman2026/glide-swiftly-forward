...
function AuditPage() {
  ...
  return (
    <div>
      <PageHeader
        title="سجل التدقيق"
        subtitle="سجل جميع العمليات الحساسة على النظام"
        action={
          <button
            onClick={load}
      ...
      {loading ? (
        ...
        <EmptyState
          icon={Shield}
          title="لا توجد سجلات"
          description="لم يتم تسجيل أي عمليات مطابقة للبحث."
        />
      ) : (
            ...
            <div className="space-y-3 text-sm">
              ...
              {detail.old_data && (
                <div>
                  ...
                  <pre className="max-h-64 overflow-auto rounded-lg bg-secondary/60 p-3 text-[11px]" dir="ltr">
